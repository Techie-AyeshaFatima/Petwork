document.addEventListener('DOMContentLoaded',function() {
  ...
  function edit_handeler(element) {
    ...
    if (edit_btn.textContent == "Edit") {
        ...
        console.log(`#post-edit-${id}`.value);
      ...
      fetch("/like/", {
        ...
        .then((response) => {
          if (response.status == 201) {
            if (response.is_liked === "yes") {
              icon.src = "https://img.icons8.com/?size=100&id=123964&format=png&color=000000";
            ...
            count.textContent = response.like_count;
          }
        })
